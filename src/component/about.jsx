                ...
                <div className="row" style={{ marginTop: 7 + "rem" }}>
                    <div className="col-12 col-lg-6 hidden">
                        ...
                        <p className={"mytext pt-3 " + this.props.fadeIn}>
                            ...
                            I am passionate about using multiple languages to create a easy user experience.
                            With two years of experience developing web applications using the latest
